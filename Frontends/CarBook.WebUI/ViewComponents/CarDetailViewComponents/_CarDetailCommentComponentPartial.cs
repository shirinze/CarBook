...
namespace CarBook.WebUI.ViewComponents.CarDetailViewComponents
{
	public class _CarDetailCommentComponentPartial:ViewComponent
	{
		...
		public _CarDetailCommentComponentPartial(IHttpClientFactory httpClientFactory)
		{
		...
		public async Task<IViewComponentResult> InvokeAsync(int id)
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:7100/api/Reviews?id=" + id);
